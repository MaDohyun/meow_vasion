...
export const STRINGS: Record<Language, Strings> = {
  ko: {
    ...
    tutorialBriefing: [
      ...
      { lines: ['먼저 조종이다. 이 기체에 이동 키는 없다 — 늘 스스로 앞으로 날아간다.', '[[마우스로 조준점을 움직이면 기체가 그쪽을 보고, 보는 방향 그대로 나아간다]].', '위를 보면 올라가고 아래를 보면 내려간다. 대원이 정할 것은 방향 하나뿐이다.'] },
  ...
  ja: {
    ...
    tutorialBriefing: [
      ...
      { lines: ['まずは操縦だ。この機体に移動キーはない — 常に自分から前へ飛ぶ。', '[[マウスで照準を動かせば機体はそちらを向き、向いた方向へそのまま進む]]。', '上を見れば上がり、下を見れば下がる。決めるのは方向ひとつだけだ。'] },
  ...
  en: {
    ...
    tutorialBriefing: [
      ...
      { lines: ['Flying first. This craft has no movement keys - it is always going forward.', '[[Move the reticle with the mouse and the craft looks that way, then flies that way]].', 'Look up to climb, look down to dive. All you ever choose is where to point.'] },
