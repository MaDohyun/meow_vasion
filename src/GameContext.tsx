 ...
 *
 * Machines burn; people do not. Soldiers and beat officers are deliberately
 * absent - the laser burst they already get is the right weight for them, and
 * a fireball would make shooting a person read as demolition.
 */
...
function registerEnemyHit(game: GameRuntime, id: string, damage: number) {
  ...
  // Machines go up; people do not. A drone, a helicopter or a tank leaving a
  // fireball is the point of shooting it, and putting one on a soldier or a
  // beat officer would be something else entirely.
